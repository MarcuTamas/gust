...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int id, String fullName, String email, String role, int streakDays});
}
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, fullName: $fullName, email: $email, role: $role, streakDays: $streakDays)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, fullName, email, role, streakDays);
...
abstract class _User implements User {
  const factory _User(
      ...
      final int streakDays}) = _$UserImpl;
...
class _$StreakResponseImpl implements _StreakResponse {
  const _$StreakResponseImpl({required this.streak});
...
abstract class _StreakResponse implements StreakResponse {
  const factory _StreakResponse({required final int streak}) =
