...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  Future<bool> login(String email, String password) async {
    ...
    try {
      ...
      // Creează un User din datele din răspuns
      final user = User(
        email: response.email,
        fullName: '', // dacă nu primești fullName, lasă gol sau adaptează
        role: response.role,
      );
  ...
  String _getErrorMessage(dynamic error) {
    print('Backend error: $error'); // <-- vezi eroarea completă în consola Flutter
